...
bcMember(m1,c1,false,'void','nextRegionAction(Vertex)').
bcMember(m2,c1,false,'void','init_vertex(Vertex)').
bcMember(m3,c1,false,'void','preVisitAction(Vertex)').
bcMember(m4,c1,false,'void','checkNeighborAction(Vertex,Vertex)').
bcMember(m5,c1,false,'void','postVisitAction(Vertex)').
...
bcMember(m6,c4,false,'void','addAnEdge(Vertex,Vertex,int)').
bcMember(m7,c4,true,'void','startProfile)').
bcMember(m8,c4,false,'Vertex','findsVertex(String)').
bcMember(m9,c4,true,'void','stopProfile)').
bcMember(m10,c4,true,'void','resumeProfile)').
bcMember(m11,c4,true,'void','endProfile)').
bcMember(m12,c4,false,'void','runBenchmark(String)').
bcMember(m13,c4,false,'int','readNumber)').
bcMember(m14,c4,false,'void','addVertex(Vertex)').
bcMember(m15,c4,false,'void','stopBenchmark)').
bcMember(m16,c4,false,'void','display)').
bcMember(m17,c4,false,'void','NumberVertices)').
bcMember(m18,c4,false,'void','addEdge(Edge)').
bcMember(m19,c4,false,'void','addOnlyEdge(Edge)').
bcMember(m20,c4,false,'boolean','CycleCheck)').
bcMember(m21,c4,false,'void','GraphSearch(WorkSpace)').
...
bcMember(m7,c5,false,'void','VertexConstructor)').
bcMember(m8,c5,false,'void','addNeighbor(Neighbor)').
bcMember(m9,c5,false,'Vertex','assignName(String)').
bcMember(m10,c5,false,'void','dftNodeSearch(WorkSpace)').
bcMember(m11,c5,false,'void','display)').
bcMember(m12,c5,false,'void','init_vertex(WorkSpace)').
...
bcMember(m3,c7,false,'void','EdgeConstructor(Vertex,Vertex,int)').
bcMember(m4,c7,false,'void','EdgeConstructor(Vertex,Vertex)').
bcMember(m5,c7,false,'void','adjustAdorns(Edge)').
bcMember(m6,c7,false,'void','display)').
