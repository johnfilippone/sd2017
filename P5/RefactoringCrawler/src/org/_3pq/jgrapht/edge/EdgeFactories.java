 ...
 * Contributor(s):   -
 *
 * $Id: EdgeFactories.java,v 1.1 2005/04/13 19:21:25 dig Exp $
 *
 * Changes
 * -------
...
public final class EdgeFactories {
    ...
    public static class DirectedEdgeFactory extends AbstractEdgeFactory {
        ...
        public Edge createEdge(Object source, Object target, String label){
        	return new DirectedEdge(source, target, label);
        }
    }
