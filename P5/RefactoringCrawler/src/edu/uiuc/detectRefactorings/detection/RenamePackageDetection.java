...
public class RenamePackageDetection extends PackageDetection {
	...
	public void createCallerGraph(Node originalNode, AbstractBaseGraph graph,
		...
		try {
			...
			SearchPattern pattern = SearchPattern.createPattern(originalNode
					.getFullyQualifiedName(), IJavaSearchConstants.PACKAGE,
	...
	public List pruneOriginalCandidates(List candidates) {
		...
		for (Iterator iter = candidates.iterator(); iter.hasNext();) {
			...
			if (pair[0].getFullyQualifiedName().equals(
