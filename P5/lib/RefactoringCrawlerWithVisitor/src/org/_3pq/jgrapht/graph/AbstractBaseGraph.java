 ...
 *
 * $Id: AbstractBaseGraph.java,v 1.5 2005/09/17 19:19:50 can Exp $
 *
 * Changes
 * -------
...
public abstract class AbstractBaseGraph extends AbstractGraph implements Graph,
    Cloneable, Serializable {
     static final private String LOOPS_NOT_ALLOWED = "loops not allowed";
    ...
    // private
     ...
     transient private Set m_unmodifiableEdgeSet   = null;
     transient private Set m_unmodifiableVertexSet = null;
     private Specifics     m_specifics;
     private boolean       m_allowingMultipleEdges;

	 private Map namedVertexMap; // map between names and the actual vertex
	...
	public Node findNamedNode(String name){
		return (Node)namedVertexMap.get(name);
	}
	...
	/**
	 * Added by Danny
	 * Allows one to add labeled edges in between two nodes
	 * @param sourceVertex
	 * @param targetVertex
	 * @param label
	 * @return
	 */
	public Edge addEdge( Object sourceVertex, Object targetVertex, String label ) {
         assertVertexExist(sourceVertex);
         assertVertexExist(targetVertex);
		...
		if (!(m_edgeFactory instanceof EdgeFactories.DirectedEdgeFactory))
			throw new IllegalArgumentException("this factory should allow directed edges");
        Edge e =    ((EdgeFactories.DirectedEdgeFactory) m_edgeFactory).createEdge(sourceVertex, targetVertex, label);
	...
	/** added by Danny Dig
	 * Since there is a mapping between Vertices and their names, this creation method
	 * allows for searching vertices based on their names.
	 * 
     * @see Graph#addVertex(Object)
     */
     ...
     * @author Barak Naveh
     */
     abstract private class Specifics {
        /**
         * .
         *
         * @param sourceVertex
     ...
     * @author Barak Naveh
     */
     static private class DirectedEdgeContainer implements Serializable {
        List                   m_incoming             = new ArrayList( 1 );
        List                   m_outgoing             = new ArrayList( 1 );
         transient private List m_unmodifiableIncoming = null;
         transient private List m_unmodifiableOutgoing = null;
     ...
     */
     private class DirectedSpecifics extends Specifics implements Serializable {
         static final private String NOT_IN_DIRECTED_GRAPH =
     ...
     * @author Barak Naveh
     */
     static private class UndirectedEdgeContainer implements Serializable {
        List                   m_vertexEdges             = new ArrayList( 1 );
         transient private List m_unmodifiableVertexEdges = null;
     ...
     */
     private class UndirectedSpecifics extends Specifics implements Serializable {
         static final private String NOT_IN_UNDIRECTED_GRAPH =
