 ...
 *
 * $Id: CrossComponentIterator.java,v 1.1 2005/04/13 19:21:25 dig Exp $
 *
 * Changes
 * -------
...
public abstract class CrossComponentIterator extends AbstractGraphIterator {
     static final private int CCS_BEFORE_COMPONENT = 1;
     static final private int CCS_WITHIN_COMPONENT = 2;
     static final private int CCS_AFTER_COMPONENT  = 3;

    //
     final private ConnectedComponentTraversalEvent m_ccFinishedEvent =
        new ConnectedComponentTraversalEvent( this,
            ConnectedComponentTraversalEvent.CONNECTED_COMPONENT_FINISHED );
     final private ConnectedComponentTraversalEvent m_ccStartedEvent =
        new ConnectedComponentTraversalEvent( this,
     ...
     * graph.
     */
     static private class DirectedSpecifics extends Specifics {
     ...
     */
     static private class UndirectedSpecifics extends Specifics {
